...
@Slf4j
@Service("TeachingProgramImportServiceImpl")
public class TeachingProgramImportServiceImpl extends AbstractGheetExtractorService<TeachingProgramDTO> {

	@Value("${gsheet.importing.M04-CRPP.sheet.name:M04-CRPS_040123}")
	...
	protected List<Boolean> doImport(String spreadsheetCode, String name, List<TeachingProgramDTO> listData) throws Exception {
		log.info("[TeachingProgramImportServiceImpl] Size of list data + {}", CollectionUtils.isEmpty(listData) ? 0 : listData.size());
	...
	public String getServiceName() {
		return "TeachingProgramImportServiceImpl";
	}
}
