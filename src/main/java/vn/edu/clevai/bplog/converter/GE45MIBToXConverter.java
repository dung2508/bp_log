...
@Slf4j
@Component
public class GE45MIBToXConverter extends GE45MIToXBaseConverter {

	public GE45MIBToXConverter(BpClagClassgroupService bpClagClassgroupService, AuthoringService authoringService, LmsService lmsService, UserService userService, ContentItemService contentItemService, CuiService cuiService, BpClagClassgroupRepository clagRepository, ZoomMeetingRepository zoomMeetingRepository, BpClagPODService bpClagPODService, BpPodProductOfDealService podService, ModelMapper modelMapper) {
