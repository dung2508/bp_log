...
@Slf4j
@Component
public class GE45MICToXConverter extends GE45MIToXBaseConverter {

	public GE45MICToXConverter(BpClagClassgroupService bpClagClassgroupService, AuthoringService authoringService, LmsService lmsService, UserService userService, ContentItemService contentItemService, CuiService cuiService, BpClagClassgroupRepository clagRepository, ZoomMeetingRepository zoomMeetingRepository, BpClagPODService bpClagPODService, BpPodProductOfDealService podService, ModelMapper modelMapper) {
