...
@Component
@Slf4j
public class LI45MIToXConverter extends BaseXConverter {

	public LI45MIToXConverter(BpClagClassgroupService bpClagClassgroupService, AuthoringService authoringService, LmsService lmsService, UserService userService, ContentItemService contentItemService, CuiService cuiService) {
	...
	public void execute(String xdsc, String lct, String dfge, List<BpUniqueLearningComponent> ulcs) {
		...
		createOrUpdateXDscLecturer(xdsc, findFirstTeacher(ulc.getCode(), UsiTypeEnum.LTE));
